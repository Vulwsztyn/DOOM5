...
void main(void) {
    ...
    vec4 ks=vec4(0.2,0.2,0.2,0); //Kolor obiektu w swietle odbitym
    ...
    float rv=pow(max(dot(r,v),0),2); //Kosinus kata pomiedzy wektorami do obserwatora i odbitym, podniesiony do wykladnika Phonga
